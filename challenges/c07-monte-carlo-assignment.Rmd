...
-   You chose a correct value of `stat(x, y)` when `x, y` is *outside* the circle. Why did you choose this value?
    -   I chose 4 because as the stat function is written it will multiply the squared sum by 4 if it is less than or equal to 1. I knew given the inputs the squared sum would certainly be 1 and hence be multiplied by 4.
-   You chose a correct value of `stat(x, y)` when `x, y` is *inside* the circle. Why did you choose this value?
    -   I chose 0 because I knew the stat function would produce a squared sum greater than 1. Meaning that the point was not part of the circle and therefore is a 0 value.
...
-   What is a range of plausible values, based on the sampling distribution you've generated?
    ...
    -   the data displays a normal distribution centered around 3.14, indicating a reasonable result on average.
