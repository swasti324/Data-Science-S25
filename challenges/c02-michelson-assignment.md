...
you will analyze Michelson’s original data, and explotre some of the
...
- Graph 1: Removed Simulated Data and Plotted Velocity (in Vacuum)
  ...
  - Since Temperature is traditionally an independent variable, I
    ...
    - According to this graph it is hard to map any relationship between
      temperature affecting the velocity measurements
- Graph 2: Added Distinctness Coloring
  - Another element I wanted to see is if plotting the distinctness
    ...
    - There is a larger cluster of level 1 (poor) points under 70 F
      however there isn’t anything definitive from this either as the
      level 2 (fair) and level 3 (good) points are scattered with no
